...
func (c *ConceptTutorSkill) Description() string  { return "知识点讲解——分步教学、互动确认，帮你深入理解技术概念" }
...
func (c *ConceptTutorSkill) fetchRAGContext(ctx context.Context, topic string, userID string) string {
	if userID == "" {
		userID = "default_user"
	}
