...
func (t *TechCompareSkill) Description() string  { return "技术对比——多维度对比分析、场景化选型建议、面试话术" }
...
func (t *TechCompareSkill) fetchRAGContext(ctx context.Context, topic string, userID string) string {
	if userID == "" {
		userID = "default_user"
	}
